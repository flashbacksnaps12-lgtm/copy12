      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 flex flex-row items-center justify-between gap-2 md:gap-4">
        ...
        <div className="flex-1 md:flex-initial">
          ...
          <div className="md:hidden scroll-loop-container">
            <div className="scroll-loop gap-2">
              <button className="px-3 py-1.5 text-xs font-semibold border-2 border-[#FBBF24] text-[#FBBF24] rounded-full hover:bg-[#FBBF24] hover:text-[#1A1A1A] transition whitespace-nowrap flex-shrink-0">
                +91 91499 02323
              </button>
              <button className="px-3 py-1.5 text-xs font-semibold border-2 border-[#FBBF24] text-[#FBBF24] rounded-full hover:bg-[#FBBF24] hover:text-[#1A1A1A] transition whitespace-nowrap flex-shrink-0">
                +91 91495 11328
